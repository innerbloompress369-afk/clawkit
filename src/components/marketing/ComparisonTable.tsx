...
export default function ComparisonTable() {
  return (
    <section className="max-w-4xl mx-auto px-6 py-16">
      <h2 className="text-3xl font-bold text-center mb-4">What&apos;s built into every package</h2>
      <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">Every package ships complete — not just prompts. Real infrastructure, built in.</p>
